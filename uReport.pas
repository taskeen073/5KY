...
type
  TfrReport = class(TIWAppForm)
    ...
    procedure displayGridReportCellClick(ASender: TObject; const ARow,
      AColumn: Integer);
    procedure cbAllDateAsyncClick(Sender: TObject; EventParams: TStringList);
    procedure cbAllDueDateAsyncClick(Sender: TObject; EventParams: TStringList);
  public
  mark:boolean;
  emp,JT:string;
  TmpIndex,i:integer;
...
procedure TfrReport.cbAllDateAsyncClick(Sender: TObject;
  EventParams: TStringList);
begin
    if cbAllDate.Checked then
      ...
      begin
         edBeginDate.Enabled:=true;
         edendDate.Enabled:=true;
      end;
end;

procedure TfrReport.cbAllDueDateAsyncClick(Sender: TObject;
  EventParams: TStringList);
begin
    if cbAllDueDate.Checked then
        begin
            edDueDate.Enabled:=False;
        end
    else
        begin
            edDueDate.Enabled:=true;
        end;
end;
